...
inline bool operator==(const Token &lhs, const Token &rhs) noexcept {
    ...
    return lhs.type == rhs.type && lhs.line == rhs.line && lhs.col == rhs.col && lhs.str == rhs.str;
}

inline bool operator!=(const Token &lhs, const Token &rhs) noexcept { return !operator==(lhs, rhs); }
